...
export type EffectiveModelModeDescription = Readonly<{
    /** The user-requested model that owns picker selection and future turns. */
    selectedModelId: string;
    /** The model explicitly recorded as applied by the provider, when available. */
    appliedModelId: string | null;
    /** @deprecated Use selectedModelId. Retained for internal callers during migration. */
    effectiveModelId: string;
    /** @deprecated Use selectedModelId. Retained for runtime diagnostics consumers. */
    requestedModelId: string;
    /**
     * Last provider model reported through legacy session metadata. This is diagnostic
     * context only and is never used to claim that the requested model was applied.
     */
...
export function describeEffectiveModelMode(params: {
    ...
    return {
        ...
        requestedModelId: resolvedSelectedModelId,
