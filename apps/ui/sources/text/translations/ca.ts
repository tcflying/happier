...
settingsSession: {
    ...
    message: {
      ...
      chatFooter: {
        ...
        directSessionControlledByCurrentHappier: ({ session, pid }: { session: string; pid: string | number }) => `Controlada per aquesta sessió Happier (${session}, procés ${pid}).`,
        ...
        directSessionControlledElsewhere: 'Aquesta sessió directa està controlada en un altre lloc. Pren-ne el control a Happier per respondre.',
