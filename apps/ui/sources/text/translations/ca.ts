...
export const ca: TranslationStructure = {
    ...
    status: {
        ...
        working: 'treballant...',
        thinking: 'pensant...',
        thinkingActivities: 'pensant|processant|calculant|analitzant|construint|treballant',
...
settingsSession: {
    ...
    message: {
      ...
      chatFooter: {
        ...
        directSessionControlledByHappier: "Aquesta sessió directa està controlada actualment per Happier Direct.",
        directSessionControlledByCurrentHappier: ({ session, pid }: { session: string; pid: string | number }) => `Controlada exclusivament per aquesta sessió Happier (${session}, procés ${pid}).`,
        directSessionControlledByOtherHappier: ({ session, pid }: { session: string; pid: string | number }) => `Controlada per una altra sessió Happier (${session}, procés ${pid}).`,
        directSessionControlledByProviderProcess: "Aquesta sessió directa està controlada actualment per {provider} (procés {pid}).",
        directSessionControlledElsewhere: "Aquesta sessió directa es controla en un altre lloc. Pren-ne el control a Happier per respondre.",
