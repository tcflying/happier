...
export const en = {
    ...
    status: {
        ...
        working: 'working...',
        thinking: 'Thinking…',
        thinkingActivities: 'accomplishing|actioning|actualizing|baking|booping|brewing|calculating|cerebrating|channelling|churning|coalescing|cogitating|computing|combobulating|concocting|conjuring|considering|contemplating|cooking|crafting|creating|crunching|deciphering|deliberating|determining|divining|elucidating|envisioning|forging|forming|generating|hatching|ideating|imagining|incubating|inferring|manifesting|marinating|mulling|musing|noodling|percolating|pondering|processing|puzzling|ruminating|scheming|simmering|spinning|synthesizing|thinking|tinkering|transmuting|unfurling|unravelling|wandering|whirring|wizarding|working|wrangling',
...
settingsSession: {
    ...
    chatFooter: {
        ...
        directSessionControlledByHappier: 'This direct session is currently controlled by Happier Direct.',
        directSessionControlledByCurrentHappier: ({ session, pid }: { session: string; pid: string | number }) => `Exclusively controlled by this Happier session (${session}, process ${pid}).`,
        directSessionControlledByOtherHappier: ({ session, pid }: { session: string; pid: string | number }) => `Controlled by another Happier session (${session}, process ${pid}).`,
        directSessionControlledByProviderProcess: 'This direct session is currently controlled by {provider} (process {pid}).',
        directSessionControlledElsewhere: 'This direct session is controlled elsewhere. Take it over in Happier to reply.',
