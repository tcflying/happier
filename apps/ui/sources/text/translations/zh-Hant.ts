...
const zhHantOverrides: DeepPartial<TranslationStructure> = {
  settingsKeyboard: {
    ...
    status: {
        ...
        working: '正在工作...',
        thinking: '正在思考…',
        thinkingActivities: '正在完成|正在執行|正在落實|正在準備|正在醞釀|正在計算|正在動腦|正在串聯|正在處理|正在匯聚|正在推敲|正在運算|正在組合|正在構思|正在生成|正在考慮|正在沉思|正在打磨|正在創造|正在解析|正在解讀|正在研判|正在推演|正在闡明|正在規劃|正在成形|正在產出|正在構想|正在想像|正在推斷|正在整理|正在琢磨|正在探索|正在沉澱|正在權衡|正在解謎|正在複盤|正在整合|正在綜合|正在思考|正在調試|正在轉化|正在展開|正在梳理|正在巡檢|正在工作|正在協調',
        readyForReview: '已可審閱',
        offline: '離線',
...
settingsSession: {
    ...
    chatFooter: {
        ...
        directSessionControlledByHappier: "此直接工作階段目前由 Happier 直連執行器操作。",
        directSessionControlledByCurrentHappier: ({ session, pid }: { session: string; pid: string | number }) => `目前由本 Happier 工作階段獨佔（工作階段 ${session}，程序 ${pid}）。`,
        directSessionControlledByOtherHappier: ({ session, pid }: { session: string; pid: string | number }) => `目前由另一個 Happier 工作階段操作（工作階段 ${session}，程序 ${pid}）。`,
        directSessionControlledByProviderProcess: "此直接工作階段目前由 {provider}（程序 {pid}）操作。",
        directSessionControlledElsewhere: "此直接工作階段正由其他執行器操作；請先在 Happier 中接管後再傳送。",
